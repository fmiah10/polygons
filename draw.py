...
def add_box( polygons, x, y, z, width, height, depth ):
    ...
    add_polygon(polygons, x1, y1, z1, x, y1, z1, x1, y1, z)
    ...
    for lat in range(lat_start, lat_stop+1):
        for longt in range(longt_start, longt_stop+1):
            ...
            if (index % steps != steps - 1):
                p0 = points[index]
                p1 = points[index + 1]
                p2 = points[index + steps + 1]
                p3 = points[index + steps]
                add_polygon(polygons, p0[0], p0[1], p0[2], p2[0], p2[1], p2[2], p3[0], p3[1], p3[2])
                if (index % steps != steps - 1 or index % steps != 0):
